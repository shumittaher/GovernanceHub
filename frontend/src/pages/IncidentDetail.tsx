  ...
  return (
    <div className="flex justify-center bg-slate-50">
      <div className="w-full h-full max-w-4xl p-8 bg-white rounded shadow">
        ...
        <h1 className="text-2xl font-semibold mt-4 text-slate-900">Incident Detail</h1>

        {loading && <p className="mt-4 text-sm text-slate-600">Loading incident...</p>}
        ...
        {!loading && !error && incident && !editing && (
          <div className="mt-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-start mt-2 py-4 text-slate-700">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded border border-slate-200 p-4 bg-slate-50">
                ...
                <p className="mt-1 font-medium text-slate-900">{incident.severity}</p>
              </div>
              <div className="rounded border border-slate-200 p-4 bg-slate-50">
                <p className="text-sm text-slate-600">Status</p>
                <p className="mt-1 font-medium text-slate-900">{incident.status}</p>
              </div>
              <div className="sm:col-span-2 rounded border border-slate-200 p-4 bg-slate-50">
                <p className="text-sm text-slate-600">Assigned To</p>
                <p className="mt-1 font-medium text-slate-900">{incident.assigned_to || 'Unassigned'}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <form onSubmit={handleSave} className="mt-6 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                onClick={cancelEdit}
                disabled={saving}
                className="px-4 py-2 text-sm border border-slate-300 rounded hover:bg-slate-50 disabled:opacity-50 text-slate-700"
              >
                Cancel
              </button>
            </div>
